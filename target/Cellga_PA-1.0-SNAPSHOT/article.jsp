<%-- 
    ...
    Created on : 8/09/2022, 03:51:34 PM
    Author     : 
--%>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp#projects">Projects</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp#pricing">Pricing</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false">Drop</a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                            <li><a class="dropdown-item" href="article.jsp">Article Details</a></li>
                ...
                <span class="nav-item">
                    <a class="btn-solid-sm" href="index.jsp#contact">Get quote</a>
                </span>
